// Code generated by brent_test.go.tmpl. DO NOT EDIT.
...
func ExampleBrent32() {
	...
	x, err := f32.Brent(a, b, 1e-9, f, logger)
	if err != nil {
...
func ExampleBissection32() {
	...
	var logger *log.Logger
	//logger = log.New(os.Stdout, "", 0)
	x, err := f32.Bissection(a, b, 1e-9, f, logger)
	if err != nil {
		log.Fatal(err)
	}
	// _Output:
...
func ExampleBrent64() {
	...
	var logger *log.Logger
	//logger = log.New(os.Stdout, "", 0)
	x, err := f64.Brent(a, b, 1e-9, f, logger)
	if err != nil {
		fmt.Println(err.Error())
	}
...
func ExampleBissection64() {
	...
	var logger *log.Logger
	//logger = log.New(os.Stdout, "", 0)
	x, err := f64.Bissection(a, b, 1e-9, f, logger)
	if err != nil {
		log.Fatal(err)
	}
	// _Output:
